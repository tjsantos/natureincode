...
/*
* original code from natureincode.com/code/3/visual_genetic_drift.html
* adapted by TJ Santos
* */
function drawLineChart(selector, data,x_label,y_label,legend_values,x_max,y_max_flex) {
